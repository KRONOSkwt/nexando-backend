...
class MessageSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        target_id = None
        if recipient_data:
            if hasattr(recipient_data, 'id'):
                target_id = recipient_data.id
            elif isinstance(recipient_data, dict):
                target_id = recipient_data.get('id')
            elif isinstance(recipient_data, int):
                target_id = recipient_data

        if request and target_id and request.user.id == target_id:
